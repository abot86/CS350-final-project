...
##Buttons C=reset, L=rest, R=active
...
##Pmod Header JB -> PWM OUT
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { JB }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { JB_clk }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
